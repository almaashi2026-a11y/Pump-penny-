...
CHAT_ID = "ضع_رقم_الشات_آي_دي_هنا" # <--- ضع رقمك هنا بين علامتي التنصيص
...
def verify_connection():
    if not BOT_TOKEN or not CHAT_ID or CHAT_ID == "ضع_رقم_الشات_آي_دي_هنا":
        logging.error("8895817474")
        return False
    return True
